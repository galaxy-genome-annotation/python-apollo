import click
from arrow.commands.status.addStatus import cli as func0
from arrow.commands.status.deleteStatus import cli as func1
from arrow.commands.status.findAllStatuses import cli as func2
from arrow.commands.status.findStatusById import cli as func3

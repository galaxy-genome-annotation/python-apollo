...
from arrow.commands.groups.get_groups import cli as func2
from arrow.commands.groups.get_organism_permissions import cli as func3
from arrow.commands.groups.show_group import cli as func4
from arrow.commands.groups.update_group import cli as func5
